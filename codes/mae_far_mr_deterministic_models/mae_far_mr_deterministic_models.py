...
def get_s2s_deterministic_twice_weekly(yr,data_dir):
    """
...
def compute_onset_for_deterministic_model(p_model, thresh_slice, onset_da, max_forecast_day=15, mok=True):
...
def compute_metrics_multiple_years(years, s2s_data_dir, imd_folder, thres_file, 
    ...
    for year in years:
        ...
        p_model = get_s2s_deterministic_twice_weekly(year, s2s_data_dir)
